...
def main() -> None:
    ...
    # The GUI registers them at startup but the subprocess gets a fresh
    # registry; without this, ``set_active_tool("custom:...")`` would
    # raise and the Cartesian collision pre-flight would fall through.
    try:
